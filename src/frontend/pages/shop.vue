<template>
  <section class="container has-text-centered">
    ...
    <p>Here you can buy robots using your Arithmecoins (<img src="~/assets/arithmecoin_small.png" class="ac-image" alt="arithmecoin" />). Need more Arithmecoin? You can earn some by getting first, second, or third place in <n-link to='/race'>a race</n-link>. Or you can <n-link to='/buy'>buy some</n-link> if you're really that impatient.</p>
    <div class="columns">
