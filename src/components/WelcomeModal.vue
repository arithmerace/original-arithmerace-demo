...
<form action="">
  <div class="modal-card" style="width: auto">
    ...
    <section class="modal-card-body">
      <p class="center">Before you can get started, we need to know how much math you know. Please check all skills and topics that you know well enough to solve problems related to them. These will be used in the future to personalize the problems for your knowledge. As you learn new topics, you can update this list in your profile.</p>
      <br>
      <b-field label="What skills do you know?">
        <div class="columns">
          <div class="column">
